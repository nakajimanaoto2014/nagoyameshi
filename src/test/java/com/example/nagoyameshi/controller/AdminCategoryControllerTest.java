...
public class AdminCategoryControllerTest {
	...
	@Test
	public void 未ログインの場合は管理者用のカテゴリ一覧ページからログインページにリダイレクトする()
		throws Exception{
	...
	public void 一般ユーザーとしてログイン済みの場合は管理者用のカテゴリ一覧ページが表示されずに403エラーが発生する()
		throws Exception{
	...
	public void 管理者としてログイン済みの場合は管理者用のカテゴリ一覧ページが正しく表示される()
		throws Exception{
	...
	@Test
	@Transactional
	public void 未ログインの場合はカテゴリを登録せずにログインページにリダイレクトする()
		throws Exception{
		...
		@WithUserDetails("taro.samurai@example.com")
		@Transactional
		public void 一般ユーザーとしてログイン済みの場合はカテゴリを登録せずに403エラーが発生する()
			throws Exception{
		...
		@WithUserDetails("hanako.samurai@example.com")
		@Transactional
		public void 管理者としてログイン済みの場合はカテゴリ登録後にカテゴリ一覧ページにリダイレクトする()
			throws Exception{
		...
		@Test
		@Transactional
		public void 未ログインの場合はカテゴリを更新せずにログインページにリダイレクトする()
			throws Exception{
		...
		@WithUserDetails("taro.samurai@example.com")
		@Transactional
		public void 一般ユーザーとしてログイン済みの場合はカテゴリを更新せずに403エラーが発生する()
			throws Exception{
		...
		@WithUserDetails("hanako.samurai@example.com")
		@Transactional
		public void 管理者としてログイン済みの場合はカテゴリ更新後にカテゴリ一覧ページにリダイレクトする()
			throws Exception{
		...
		@Test
		@Transactional
		public void 未ログインの場合はカテゴリを削除せずにログインページにリダイレクトする()
				throws Exception{
		...
		@WithUserDetails("taro.samurai@example.com")
		@Transactional
		public void 一般ユーザーとしてログイン済みの場合はカテゴリを削除せずに403エラーが発生する()
			throws Exception{
		...
		@WithUserDetails("hanako.samurai@example.com")
		@Transactional
		public void 管理者としてログイン済みの場合はカテゴリ削除後にカテゴリ一覧ページにリダイレクトする()
			throws Exception{
