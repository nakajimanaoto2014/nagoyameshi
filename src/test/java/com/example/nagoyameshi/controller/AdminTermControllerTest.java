...
public class AdminTermControllerTest {
	...
	@Test
	public void 未ログインの場合は管理者用の利用規約ページからログインページにリダイレクトする()
		throws Exception{
	...
	public void 一般ユーザーとしてログイン済みの場合は管理者用の利用規約ページが表示されずに403エラーが発生する()
		throws Exception{
	...
	public void 管理者としてログイン済みの場合は管理者用の利用規約ページが正しく表示される()
		throws Exception{
	...
	@Test
	public void 未ログインの場合は管理者用の利用規約編集ページからログインページにリダイレクトする()
		throws Exception{
	...
	@Test
	@WithUserDetails("taro.samurai@example.com")
	public void 一般ユーザーとしてログイン済みの場合は管理者用の利用規約編集ページが表示されずに403エラーが発生する()
		throws Exception{
	...
	@Test
	@WithUserDetails("hanako.samurai@example.com")
	public void 管理者としてログイン済みの場合は管理者用の利用規約編集ページが正しく表示される()
		throws Exception{
	...
	@Test
	@Transactional
	public void 未ログインの場合は利用規約を更新せずにログインページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void 一般ユーザーとしてログイン済みの場合は利用規約を更新せずに403エラーが発生する()
		throws Exception{
	...
	@WithUserDetails("hanako.samurai@example.com")
	@Transactional
	public void 管理者としてログイン済みの場合は利用規約更新後に利用規約ページにリダイレクトする()
		throws Exception{
