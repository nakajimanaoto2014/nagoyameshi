...
public class UserControllerTest {
	...
	@Test
	public void 未ログインの場合は会員用の会員情報ページからログインページにリダイレクトする()
		throws Exception{
	...
	public void ログイン済みの場合は会員用の会員情報ページが正しく表示される()
		throws Exception{
	...
	@Test
	public void 未ログインの場合は会員用の会員情報編集ページからログインページにリダイレクトする()
		throws Exception{
	...
	@Test
	@WithUserDetails("taro.samurai@example.com")
	public void ログイン済みの場合は会員用の会員情報編集ページが正しく表示される()
		throws Exception{
	...
	@Test
	@Transactional
	public void 未ログインの場合は会員情報を更新せずにログインページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void ログイン済みの場合は会員情報更新後に会員用の会員情報ページにリダイレクトする()
		throws Exception{
