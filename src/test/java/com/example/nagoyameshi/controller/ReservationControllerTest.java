...
public class ReservationControllerTest {
	...
	@Test
	public void 未ログインの場合は予約一覧ページからログインページにリダイレクトする()
		throws Exception{
	...
	public void 無料会員としてログイン済みの場合は予約一覧ページから有料プラン登録ページにリダイレクトする()
		throws Exception{
	...
	public void 有料会員としてログイン済みの場合は予約一覧ページが正しく表示される()
		throws Exception{
	...
	public void 管理者としてログイン済みの場合は予約一覧ページが表示されずに403エラーが発生する()
		throws Exception{
	...
	@Test
	public void 未ログインの場合は予約ページからログインページにリダイレクトする()
		throws Exception{
	...
	@Test
	@WithUserDetails("taro.samurai@example.com")
	public void 無料会員としてログイン済みの場合は予約ページから有料プラン登録ページにリダイレクトする()
		throws Exception{
	...
	@Test
	@WithUserDetails("jiro.samurai@example.com")
	public void 有料会員としてログイン済みの場合は予約ページが正しく表示される()
		throws Exception{
	...
	@Test
	@WithUserDetails("hanako.samurai@example.com")
	public void 管理者としてログイン済みの場合は予約ページが表示されずに403エラーが発生する()
		throws Exception{
	...
	@Test
	@Transactional
	public void 未ログインの場合は予約せずにログインページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void 無料会員としてログイン済みの場合は予約せずに有料プラン登録ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("jiro.samurai@example.com")
	@Transactional
	public void 有料会員としてログイン済みの場合は予約後に予約一覧ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("hanako.samurai@example.com")
	@Transactional
	public void 管理者としてログイン済みの場合は予約せずに403エラーが発生する()
		throws Exception{
	...
	@Test
	@Transactional
	public void 未ログインの場合は予約をキャンセルせずにログインページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void 無料会員としてログイン済みの場合は予約をキャンセルせずに有料プラン登録ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("jiro.samurai@example.com")
	@Transactional
	public void 有料会員としてログイン済みの場合は自身の予約キャンセル後に予約一覧ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("jiro.samurai@example.com")
	@Transactional
	public void 有料会員としてログイン済みの場合は他人の予約をキャンセルせずに予約一覧ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("hanako.samurai@example.com")
	@Transactional
	public void 管理者としてログイン済みの場合は予約をキャンセルせずに403エラーが発生する()
		throws Exception{
