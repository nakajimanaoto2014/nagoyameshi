...
public class ReviewControllerTest {
	...
	@Test
	public void 未ログインの場合はレビュー一覧ページからログインページにリダイレクトする()
		throws Exception{
	...
	public void 無料会員としてログイン済みの場合はレビュー一覧ページが正しく表示される()
		throws Exception{
	...
	public void 有料会員としてログイン済みの場合はレビュー一覧ページが正しく表示される()
		throws Exception{
	...
	public void 管理者としてログイン済みの場合はレビュー一覧ページが表示されずに403エラーが発生する()
		throws Exception{
	...
	@Test
	public void 未ログインの場合はレビュー投稿ページからログインページにリダイレクトする()
		throws Exception{
	...
	@Test
	@WithUserDetails("taro.samurai@example.com")
	public void 無料会員としてログイン済みの場合はレビュー投稿ページから有料プラン登録ページにリダイレクトする()
		throws Exception{
	...
	@Test
	@WithUserDetails("jiro.samurai@example.com")
	public void 有料会員としてログイン済みの場合はレビュー投稿ページが正しく表示される()
		throws Exception{
	...
	@Test
	@WithUserDetails("hanako.samurai@example.com")
	public void 管理者としてログイン済みの場合はレビュー投稿ページが表示されずに403エラーが発生する()
		throws Exception{
	...
	@Test
	@Transactional
	public void 未ログインの場合はレビューを登録せずにログインページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void 無料会員としてログイン済みの場合はレビューを登録せずに有料プラン登録ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("jiro.samurai@example.com")
	@Transactional
	public void 有料会員としてログイン済みの場合はレビュー投稿後に店舗詳細ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("hanako.samurai@example.com")
	@Transactional
	public void 管理者としてログイン済みの場合はレビューを投稿せずに403エラーが発生する()
		throws Exception{
	...
	@Test
	public void 未ログインの場合はレビュー編集ページからログインページにリダイレクトする()
		throws Exception{
	...
	@Test
	@WithUserDetails("taro.samurai@example.com")
	public void 無料会員としてログイン済みの場合はレビュー編集ページから有料プラン登録ページにリダイレクトする()
		throws Exception{
	...
	@Test
	@WithUserDetails("jiro.samurai@example.com")
	public void 有料会員としてログイン済みの場合は自身のレビュー編集ページが正しく表示される()
		throws Exception{
	...
	@Test
	@WithUserDetails("jiro.samurai@example.com")
	public void 有料会員としてログイン済みの場合は他人のレビュー編集ページから店舗詳細ページにリダイレクトする()
		throws Exception{
	...
	@Test
	@WithUserDetails("hanako.samurai@example.com")
	public void 管理者としてログイン済みの場合はレビュー編集ページが表示されずに403エラーが発生する()
		throws Exception{
	...
	@Test
	@Transactional
	public void 未ログインの場合はレビューを更新せずにログインページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void 無料会員としてログイン済みの場合はレビューを更新せずに有料プラン登録ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("jiro.samurai@example.com")
	@Transactional
	public void 有料会員としてログイン済みの場合は自身のレビュー更新後に店舗詳細ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("jiro.samurai@example.com")
	@Transactional
	public void 有料会員としてログイン済みの場合は他人のレビューを更新せずに店舗詳細ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("hanako.samurai@example.com")
	@Transactional
	public void 管理者としてログイン済みの場合はレビューを更新せずに403エラーが発生する()
		throws Exception{
	...
	@Test
	@Transactional
	public void 未ログインの場合はレビューを削除せずにログインページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void 無料会員としてログイン済みの場合はレビューを削除せずに有料プラン登録ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("jiro.samurai@example.com")
	@Transactional
	public void 有料会員としてログイン済みの場合は自身のレビュー削除後に店舗詳細ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("jiro.samurai@example.com")
	@Transactional
	public void 有料会員としてログイン済みの場合は他人のレビューを削除せずに店舗詳細ページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("hanako.samurai@example.com")
	@Transactional
	public void 管理者としてログイン済みの場合はレビューを削除せずに403エラーが発生する()
		throws Exception{
