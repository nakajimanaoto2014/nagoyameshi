...
public class AdminCompanyControllerTest {
	...
	@Test
	public void 未ログインの場合は管理者用の会社概要ページからログインページにリダイレクトする()
		throws Exception{
	...
	public void 一般ユーザーとしてログイン済みの場合は管理者用の会社概要ページが表示されずに403エラーが発生する()
		throws Exception{
	...
	public void 管理者としてログイン済みの場合は管理者用の会社概要ページが正しく表示される()
		throws Exception{
	...
	@Test
	public void 未ログインの場合は管理者用の会社概要編集ページからログインページにリダイレクトする()
		throws Exception{
	...
	@Test
	@WithUserDetails("taro.samurai@example.com")
	public void 一般ユーザーとしてログイン済みの場合は管理者用の会社概要編集ページが表示されずに403エラーが発生する()
		throws Exception{
	...
	@Test
	@WithUserDetails("hanako.samurai@example.com")
	public void 管理者としてログイン済みの場合は管理者用の会社概要編集ページが正しく表示される()
		throws Exception{
	...
	@Test
	@Transactional
	public void 未ログインの場合は会社概要を更新せずにログインページにリダイレクトする()
		throws Exception{
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void 一般ユーザーとしてログイン済みの場合は会社概要を更新せずに403エラーが発生する()
		throws Exception{
	...
	@WithUserDetails("hanako.samurai@example.com")
	@Transactional
	public void 管理者としてログイン済みの場合は会社概要更新後に会社概要ページにリダイレクトする()
		throws Exception{
