...
public class StripeService {
	...
	//顧客(StripeのCustomerオブジェクト)のデフォルトの支払い方法(StripeのPaymentMethodオブジェクト)
	...
	public void detachPaymentMethodFromCustomer(String paymentMethodId)
		throws StripeException{
	...
	//サブスクリプションの(StripeのSubscriptionオブジェクト)をキャンセルする
	public void cancelSubscriptions(List<Subscription> subscriptions)
		throws StripeException{
